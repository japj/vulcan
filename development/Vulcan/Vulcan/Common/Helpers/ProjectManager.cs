...
namespace Vulcan.Common.Helpers
{
    public class ProjectManager
    {
        ...
        {
            Message.Trace(Severity.Debug,"Project Manager: Created Project {0}", projectName);
        ...
        private string _getProjectPath(string projectSubpath)
        {
            return projectSubpath + Path.DirectorySeparatorChar + _projectName + Resources.ExtensionDTProjectFile;
        }
    }
}
