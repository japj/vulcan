...
namespace Vulcan.Transformations
{
    ...
    {
        private IDTSComponentMetaData90 _oledbDest;
        private CManagedComponentWrapper _oledbDestI;
        ...
        {
            _oledbDestI.AcquireConnections(null);
            _oledbDestI.ReinitializeMetaData();
            _oledbDestI.ReleaseConnections();
