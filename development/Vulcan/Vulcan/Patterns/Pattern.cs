...
namespace Vulcan.Patterns
{
    ...
    public abstract class Pattern
    {
        ...
        private DTS.Executable _firstExecutableGeneratedByPattern;
        private DTS.Executable _lastExecutableGeneratedByPattern;
        ...
        public abstract void Emit(XPathNavigator patternNavigator);
        ...
        public Vulcan.Packages.VulcanPackage VulcanPackage
        {
            get
            {
        ...
        public DTS.Executable FirstExecutableGeneratedByPattern
        {
            get
            {
                return _firstExecutableGeneratedByPattern;
            }
            protected set
            {
                _firstExecutableGeneratedByPattern = value;
            }
        }

        public DTS.Executable LastExecutableGeneratedByPattern
        {
            get
            {
                return _lastExecutableGeneratedByPattern;
            }
            protected set
            {
                _lastExecutableGeneratedByPattern = value;
            }
