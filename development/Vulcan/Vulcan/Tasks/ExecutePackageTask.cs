...
namespace Vulcan.Tasks
{
    ...
    {
        public DTS.TaskHost executePackageTaskHost;
        ...
        {
            TaskHost.Properties[name].SetValue(executePackageTaskHost, value);
        }

        public override void SetExpression(string expressionName, string expressionValue)
        {
            TaskHost.SetExpression(expressionName, expressionValue);
        }
        ...
        public DTS.TaskHost TaskHost
        {
            get
            {
                return this.executePackageTaskHost;
            }
        }

        public DTSTasks.ExecutePackageTask.ExecutePackageTask Task
        {
            get
            {
                return (DTSTasks.ExecutePackageTask.ExecutePackageTask)this.executePackageTaskHost.InnerObject;
            }
        }
    }
}
