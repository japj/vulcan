...
{
    public class PrecedenceConstraint : Task
    {
        string  from;
        string to;
        ...
        {
            throw new Exception("Precedence Constraints do not have expressions.");
        }

        public override void SetProperty(string name, object value)
        {
            throw new Exception("Precedence Constraints do not have properties.");
        }
    }
}
