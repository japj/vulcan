...
namespace VulcanEngine.IR.Ast.Table
{
    ...
    [FriendlyNameAttribute("UniqueKey")]
    [AstSchemaTypeBindingAttribute("TableUniqueKeyElemType", "http://tempuri.org/vulcan2.xsd")]
    public partial class AstTableUniqueKeyNode : VulcanEngine.IR.Ast.Table.AstTableKeyBaseNode
    {
        ...
        public override void CloneInto(IFrameworkItem targetItem, Dictionary<IFrameworkItem, IFrameworkItem> cloneMapping)
        {
            ...
            if (targetItem == null || !typeof(AstTableUniqueKeyNode).IsAssignableFrom(targetItem.GetType()))
            {
        ...
        {
            return new AstTableUniqueKeyNode(parentItem);
        }
