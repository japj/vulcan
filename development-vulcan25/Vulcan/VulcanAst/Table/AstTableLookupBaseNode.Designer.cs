...
namespace VulcanEngine.IR.Ast.Table
{
    ...
    public partial class AstTableLookupBaseNode : VulcanEngine.IR.Ast.AstNamedNode
    {
        ...
        public override void CloneInto(IFrameworkItem targetItem, Dictionary<IFrameworkItem, IFrameworkItem> cloneMapping)
        {
            ...
            if (targetItem == null || !typeof(AstTableLookupBaseNode).IsAssignableFrom(targetItem.GetType()))
            {
        ...
        {
            return new AstTableLookupBaseNode(parentItem);
        }
