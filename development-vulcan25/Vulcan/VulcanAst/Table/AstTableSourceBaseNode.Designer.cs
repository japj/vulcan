...
namespace VulcanEngine.IR.Ast.Table
{
    ...
    public abstract partial class AstTableSourceBaseNode : VulcanEngine.IR.Ast.AstNamedNode
    {
        ...
        public override void CloneInto(IFrameworkItem targetItem, Dictionary<IFrameworkItem, IFrameworkItem> cloneMapping)
        {
            ...
            if (targetItem == null || !typeof(AstTableSourceBaseNode).IsAssignableFrom(targetItem.GetType()))
            {
