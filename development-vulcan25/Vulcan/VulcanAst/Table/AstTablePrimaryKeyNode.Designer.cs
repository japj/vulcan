...
namespace VulcanEngine.IR.Ast.Table
{
    ...
    [FriendlyNameAttribute("PrimaryKey")]
    [AstSchemaTypeBindingAttribute("TablePrimaryKeyElemType", "http://tempuri.org/vulcan2.xsd")]
    public partial class AstTablePrimaryKeyNode : VulcanEngine.IR.Ast.Table.AstTableKeyBaseNode
    {
        ...
        public override void CloneInto(IFrameworkItem targetItem, Dictionary<IFrameworkItem, IFrameworkItem> cloneMapping)
        {
            ...
            if (targetItem == null || !typeof(AstTablePrimaryKeyNode).IsAssignableFrom(targetItem.GetType()))
            {
        ...
        {
            return new AstTablePrimaryKeyNode(parentItem);
        }
