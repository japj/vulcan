...
namespace VulcanEngine.IR.Ast.Table
{
    ...
    [FriendlyNameAttribute("Column")]
    [AstSchemaTypeBindingAttribute("TableColumnElemType", "http://tempuri.org/vulcan2.xsd")]
    public partial class AstTableColumnNode : VulcanEngine.IR.Ast.Table.AstTableColumnBaseNode
    {
        ...
        public override void CloneInto(IFrameworkItem targetItem, Dictionary<IFrameworkItem, IFrameworkItem> cloneMapping)
        {
            ...
            if (targetItem == null || !typeof(AstTableColumnNode).IsAssignableFrom(targetItem.GetType()))
            {
        ...
        {
            return new AstTableColumnNode(parentItem);
        }
