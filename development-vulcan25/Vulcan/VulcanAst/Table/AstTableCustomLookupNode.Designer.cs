...
namespace VulcanEngine.IR.Ast.Table
{
    ...
    public partial class AstTableCustomLookupNode : VulcanEngine.IR.Ast.Table.AstTableLookupBaseNode
    {
        ...
        public override void CloneInto(IFrameworkItem targetItem, Dictionary<IFrameworkItem, IFrameworkItem> cloneMapping)
        {
            ...
            if (targetItem == null || !typeof(AstTableCustomLookupNode).IsAssignableFrom(targetItem.GetType()))
            {
                throw new ArgumentException("Provided target node is not of the correct type.");
            }
            var castedTargetItem = (AstTableCustomLookupNode)targetItem;
            foreach (var item in _transformations)
            {
        ...
        {
            return new AstTableCustomLookupNode(parentItem);
        }
