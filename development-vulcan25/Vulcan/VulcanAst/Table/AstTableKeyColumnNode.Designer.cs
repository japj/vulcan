...
namespace VulcanEngine.IR.Ast.Table
{
    ...
    public partial class AstTableKeyColumnNode : VulcanEngine.IR.Ast.Table.AstTableColumnReferenceNode
    {
        #region Private Storage
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1051:DoNotDeclareVisibleInstanceFields")]
        protected VulcanEngine.IR.Ast.Table.KeyColumnSortOrder SortOrder_BackingField;
        ...
        [VulcanDefaultValue(VulcanEngine.IR.Ast.Table.KeyColumnSortOrder.Asc)]
        [VulcanDescription(@"")]
        [Browsable(true)]
        [AstXNameBinding("SortOrder", ChildType.Attribute, DefaultValue = "Asc")]
        public VulcanEngine.IR.Ast.Table.KeyColumnSortOrder SortOrder
        {
            ...
            set
            {
                ...
                {
                    VulcanEngine.IR.Ast.Table.KeyColumnSortOrder oldValue = SortOrder_BackingField;
        ...
        {
            SortOrder_BackingField = VulcanEngine.IR.Ast.Table.KeyColumnSortOrder.Asc;
        }
        ...
        public override void CloneInto(IFrameworkItem targetItem, Dictionary<IFrameworkItem, IFrameworkItem> cloneMapping)
        {
            ...
            if (targetItem == null || !typeof(AstTableKeyColumnNode).IsAssignableFrom(targetItem.GetType()))
            {
                throw new ArgumentException("Provided target node is not of the correct type.");
            }
            var castedTargetItem = (AstTableKeyColumnNode)targetItem;
        ...
        {
            return new AstTableKeyColumnNode(parentItem);
        }
