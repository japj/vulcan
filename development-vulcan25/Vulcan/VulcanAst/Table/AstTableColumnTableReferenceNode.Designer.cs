...
namespace VulcanEngine.IR.Ast.Table
{
    ...
    [FriendlyNameAttribute("TableReferenceColumn")]
    [AstSchemaTypeBindingAttribute("TableReferenceElemType", "http://tempuri.org/vulcan2.xsd")]
    public partial class AstTableColumnTableReferenceNode : VulcanEngine.IR.Ast.Table.AstTableColumnTableReferenceBaseNode
    {
        ...
        [AstRequiredProperty]
        [VulcanDescription(@"Specifies Table.")]
        [Browsable(true)]
        ...
        public override void CloneInto(IFrameworkItem targetItem, Dictionary<IFrameworkItem, IFrameworkItem> cloneMapping)
        {
            ...
            if (targetItem == null || !typeof(AstTableColumnTableReferenceNode).IsAssignableFrom(targetItem.GetType()))
            {
                throw new ArgumentException("Provided target node is not of the correct type.");
            }
            var castedTargetItem = (AstTableColumnTableReferenceNode)targetItem;
            if (_table == null)
            {
