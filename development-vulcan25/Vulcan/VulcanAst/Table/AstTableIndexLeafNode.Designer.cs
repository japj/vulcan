...
{
    [AstSchemaTypeBindingAttribute("TableIndexLeafReferenceElemType", "http://tempuri.org/vulcan2.xsd")]
    public partial class AstTableIndexLeafNode : VulcanEngine.IR.Ast.Table.AstTableColumnReferenceNode
    {
        ...
        public override void CloneInto(IFrameworkItem targetItem, Dictionary<IFrameworkItem, IFrameworkItem> cloneMapping)
        {
            ...
            if (targetItem == null || !typeof(AstTableIndexLeafNode).IsAssignableFrom(targetItem.GetType()))
            {
        ...
        {
            return new AstTableIndexLeafNode(parentItem);
        }
