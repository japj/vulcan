...
namespace VulcanEngine.IR.Ast.Table
{
    ...
    [FriendlyNameAttribute("TableBase")]
    [AstSchemaTypeBindingAttribute("", "http://tempuri.org/vulcan2.xsd")]
    public partial class AstTableBaseNode : VulcanEngine.IR.Ast.AstSecurableNode
    {
        ...
        public override void CloneInto(IFrameworkItem targetItem, Dictionary<IFrameworkItem, IFrameworkItem> cloneMapping)
        {
            ...
            if (targetItem == null || !typeof(AstTableBaseNode).IsAssignableFrom(targetItem.GetType()))
            {
        ...
        {
            return new AstTableBaseNode(parentItem);
        }
