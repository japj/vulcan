...
{
    [FriendlyNameAttribute("TableReference")]
    [AstSchemaTypeBindingAttribute("", "http://tempuri.org/vulcan2.xsd")]
    public partial class AstTableReferenceNode : VulcanEngine.IR.Ast.AstNode
    {
        ...
        public override void CloneInto(IFrameworkItem targetItem, Dictionary<IFrameworkItem, IFrameworkItem> cloneMapping)
        {
            ...
            if (targetItem == null || !typeof(AstTableReferenceNode).IsAssignableFrom(targetItem.GetType()))
            {
                throw new ArgumentException("Provided target node is not of the correct type.");
            }
            var castedTargetItem = (AstTableReferenceNode)targetItem;
            if (_table == null)
            {
        ...
        {
            return new AstTableReferenceNode(parentItem);
        }
