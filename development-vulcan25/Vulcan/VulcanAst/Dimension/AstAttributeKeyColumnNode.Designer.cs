...
namespace VulcanEngine.IR.Ast.Dimension
{
    ...
    [FriendlyNameAttribute("KeyColumn")]
    [AstSchemaTypeBindingAttribute("", "http://tempuri.org/vulcan2.xsd")]
    public partial class AstAttributeKeyColumnNode : VulcanEngine.IR.Ast.Dimension.AstAttributeColumnNode
    {
        ...
        public override void CloneInto(IFrameworkItem targetItem, Dictionary<IFrameworkItem, IFrameworkItem> cloneMapping)
        {
            ...
            if (targetItem == null || !typeof(AstAttributeKeyColumnNode).IsAssignableFrom(targetItem.GetType()))
            {
        ...
        {
            return new AstAttributeKeyColumnNode(parentItem);
        }
