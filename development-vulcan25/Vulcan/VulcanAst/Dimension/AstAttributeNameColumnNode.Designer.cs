...
namespace VulcanEngine.IR.Ast.Dimension
{
    ...
    [FriendlyNameAttribute("NameColumn")]
    [AstSchemaTypeBindingAttribute("", "http://tempuri.org/vulcan2.xsd")]
    public partial class AstAttributeNameColumnNode : VulcanEngine.IR.Ast.Dimension.AstAttributeColumnNode
    {
        ...
        public override void CloneInto(IFrameworkItem targetItem, Dictionary<IFrameworkItem, IFrameworkItem> cloneMapping)
        {
            ...
            if (targetItem == null || !typeof(AstAttributeNameColumnNode).IsAssignableFrom(targetItem.GetType()))
            {
        ...
        {
            return new AstAttributeNameColumnNode(parentItem);
        }
