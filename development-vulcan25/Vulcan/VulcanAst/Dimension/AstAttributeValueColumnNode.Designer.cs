...
namespace VulcanEngine.IR.Ast.Dimension
{
    ...
    [FriendlyNameAttribute("ValueColumn")]
    [AstSchemaTypeBindingAttribute("", "http://tempuri.org/vulcan2.xsd")]
    public partial class AstAttributeValueColumnNode : VulcanEngine.IR.Ast.Dimension.AstAttributeColumnNode
    {
        ...
        public override void CloneInto(IFrameworkItem targetItem, Dictionary<IFrameworkItem, IFrameworkItem> cloneMapping)
        {
            ...
            if (targetItem == null || !typeof(AstAttributeValueColumnNode).IsAssignableFrom(targetItem.GetType()))
            {
        ...
        {
            return new AstAttributeValueColumnNode(parentItem);
        }
