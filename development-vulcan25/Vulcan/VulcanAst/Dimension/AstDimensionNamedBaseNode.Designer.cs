...
namespace VulcanEngine.IR.Ast.Dimension
{
    ...
    public partial class AstDimensionNamedBaseNode : VulcanEngine.IR.Ast.AstNamedNode
    {
        ...
        public override void CloneInto(IFrameworkItem targetItem, Dictionary<IFrameworkItem, IFrameworkItem> cloneMapping)
        {
            ...
            if (targetItem == null || !typeof(AstDimensionNamedBaseNode).IsAssignableFrom(targetItem.GetType()))
            {
        ...
        {
            return new AstDimensionNamedBaseNode(parentItem);
        }
