...
namespace VulcanEngine.IR.Ast.Transformation
{
    ...
    [AstSchemaTypeBindingAttribute("TransformationConditionalSplitOutputPathElemType", "http://tempuri.org/vulcan2.xsd")]
    public partial class AstConditionalSplitOutputPathNode : VulcanEngine.IR.Ast.Transformation.AstDataflowOutputPathNode
    {
        ...
        public override void CloneInto(IFrameworkItem targetItem, Dictionary<IFrameworkItem, IFrameworkItem> cloneMapping)
        {
            ...
            if (targetItem == null || !typeof(AstConditionalSplitOutputPathNode).IsAssignableFrom(targetItem.GetType()))
            {
                throw new ArgumentException("Provided target node is not of the correct type.");
            }
            var castedTargetItem = (AstConditionalSplitOutputPathNode)targetItem;
        ...
        {
            return new AstConditionalSplitOutputPathNode(parentItem);
        }
