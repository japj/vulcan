...
namespace VulcanEngine.IR.Ast.Transformation
{
    ...
    [FriendlyNameAttribute("QuerySource")]
    [AstSchemaTypeBindingAttribute("ETLQuerySourceElemType", "http://tempuri.org/vulcan2.xsd")]
    public partial class AstQuerySourceNode : VulcanEngine.IR.Ast.Transformation.AstSingleOutSourceNode
    {
        #region Private Storage
        private VulcanEngine.IR.Ast.Connection.AstConnectionNode _connection;
        private bool __isNotFirstSet__connection;

        private VulcanEngine.IR.Ast.Task.AstVariableParameterMappingQueryNode _query;
        ...
        public VulcanEngine.IR.Ast.Task.AstVariableParameterMappingQueryNode Query
        {
            get { return _query; }
            set
            {
                if (_query != value || !__isNotFirstSet__query)
                {
                    ...
                    VulcanEngine.IR.Ast.Task.AstVariableParameterMappingQueryNode oldValue = _query;
                    _query = value;
        ...
        public override void CloneInto(IFrameworkItem targetItem, Dictionary<IFrameworkItem, IFrameworkItem> cloneMapping)
        {
            ...
            if (targetItem == null || !typeof(AstQuerySourceNode).IsAssignableFrom(targetItem.GetType()))
            {
                throw new ArgumentException("Provided target node is not of the correct type.");
            }
            var castedTargetItem = (AstQuerySourceNode)targetItem;
            if (_connection == null)
            {
            ...
            {
                castedTargetItem._query = (VulcanEngine.IR.Ast.Task.AstVariableParameterMappingQueryNode)cloneMapping[_query];
        ...
        {
            return new AstQuerySourceNode(parentItem);
        }
