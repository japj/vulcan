...
namespace VulcanEngine.IR.Ast.Transformation
{
    ...
    [FriendlyNameAttribute("Multicast")]
    [AstSchemaTypeBindingAttribute("TransformationMulticastElemType", "http://tempuri.org/vulcan2.xsd")]
    public partial class AstMulticastNode : VulcanEngine.IR.Ast.Transformation.AstSingleInTransformationNode
    {
        ...
        public override void CloneInto(IFrameworkItem targetItem, Dictionary<IFrameworkItem, IFrameworkItem> cloneMapping)
        {
            ...
            if (targetItem == null || !typeof(AstMulticastNode).IsAssignableFrom(targetItem.GetType()))
            {
                throw new ArgumentException("Provided target node is not of the correct type.");
            }
            var castedTargetItem = (AstMulticastNode)targetItem;
            foreach (var item in _outputPaths)
            {
        ...
        {
            return new AstMulticastNode(parentItem);
        }
