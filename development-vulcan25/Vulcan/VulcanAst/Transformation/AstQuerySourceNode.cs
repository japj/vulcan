...
{
    public partial class AstQuerySourceNode
    {
        private const string OutputSsisName = "OLE DB Source Output";
        private const string ErrorSsisName = "OLE DB Source Error Output";
        ...
        public AstQuerySourceNode(IFrameworkItem parentAstNode)
            : base(parentAstNode)
        {
            InitializeAstNode();
