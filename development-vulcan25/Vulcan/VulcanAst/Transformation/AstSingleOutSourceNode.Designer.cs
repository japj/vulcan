...
namespace VulcanEngine.IR.Ast.Transformation
{
    ...
    public partial class AstSingleOutSourceNode : VulcanEngine.IR.Ast.Transformation.AstSourceTransformationNode
    {
        ...
        public override void CloneInto(IFrameworkItem targetItem, Dictionary<IFrameworkItem, IFrameworkItem> cloneMapping)
        {
            ...
            if (targetItem == null || !typeof(AstSingleOutSourceNode).IsAssignableFrom(targetItem.GetType()))
            {
        ...
        {
            return new AstSingleOutSourceNode(parentItem);
        }
