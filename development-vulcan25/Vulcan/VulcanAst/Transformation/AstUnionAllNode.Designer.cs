...
namespace VulcanEngine.IR.Ast.Transformation
{
    ...
    [FriendlyNameAttribute("UnionAll")]
    [AstSchemaTypeBindingAttribute("TransformationUnionAllElemType", "http://tempuri.org/vulcan2.xsd")]
    public partial class AstUnionAllNode : VulcanEngine.IR.Ast.Transformation.AstMultipleInTransformationNode
    {
        ...
        public override void CloneInto(IFrameworkItem targetItem, Dictionary<IFrameworkItem, IFrameworkItem> cloneMapping)
        {
            ...
            if (targetItem == null || !typeof(AstUnionAllNode).IsAssignableFrom(targetItem.GetType()))
            {
        ...
        {
            return new AstUnionAllNode(parentItem);
        }
