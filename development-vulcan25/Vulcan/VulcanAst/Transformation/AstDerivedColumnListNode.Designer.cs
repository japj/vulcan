...
namespace VulcanEngine.IR.Ast.Transformation
{
    ...
    [FriendlyNameAttribute("DerivedColumns")]
    [AstSchemaTypeBindingAttribute("TransformationDerivedColumnListElemType", "http://tempuri.org/vulcan2.xsd")]
    public partial class AstDerivedColumnListNode : VulcanEngine.IR.Ast.Transformation.AstSingleInTransformationNode
    {
        #region Private Storage
        private VulcanCollection<VulcanEngine.IR.Ast.Transformation.AstDerivedColumnNode> _columns;
        ...
        public VulcanCollection<VulcanEngine.IR.Ast.Transformation.AstDerivedColumnNode> Columns
        {
            get { return _columns; }
        }
        ...
        {
            VulcanEngine.IR.Ast.Transformation.AstDerivedColumnNode.ProcessAstNamedNodeCollectionAction(e);
        ...
        public override void CloneInto(IFrameworkItem targetItem, Dictionary<IFrameworkItem, IFrameworkItem> cloneMapping)
        {
            ...
            if (targetItem == null || !typeof(AstDerivedColumnListNode).IsAssignableFrom(targetItem.GetType()))
            {
                throw new ArgumentException("Provided target node is not of the correct type.");
            }
            var castedTargetItem = (AstDerivedColumnListNode)targetItem;
            foreach (var item in _columns)
            {
                IFrameworkItem candidate = cloneMapping[item];
                castedTargetItem._columns.Add((VulcanEngine.IR.Ast.Transformation.AstDerivedColumnNode)candidate);
        ...
        {
            return new AstDerivedColumnListNode(parentItem);
        }
