...
namespace VulcanEngine.IR.Ast.Transformation
{
    ...
    public partial class AstTransformationMappedQueryNode : VulcanEngine.IR.Ast.Task.AstQueryNode
    {
        ...
        public override void CloneInto(IFrameworkItem targetItem, Dictionary<IFrameworkItem, IFrameworkItem> cloneMapping)
        {
            ...
            if (targetItem == null || !typeof(AstTransformationMappedQueryNode).IsAssignableFrom(targetItem.GetType()))
            {
                throw new ArgumentException("Provided target node is not of the correct type.");
            }
            var castedTargetItem = (AstTransformationMappedQueryNode)targetItem;
            foreach (var item in _mappings)
            {
        ...
        {
            return new AstTransformationMappedQueryNode(parentItem);
        }
