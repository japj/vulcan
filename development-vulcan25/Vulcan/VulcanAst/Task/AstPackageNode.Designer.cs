...
namespace VulcanEngine.IR.Ast.Task
{
    ...
    [FriendlyNameAttribute("Package")]
    [AstSchemaTypeBindingAttribute("PackageElemType", "http://tempuri.org/vulcan2.xsd")]
    public partial class AstPackageNode : VulcanEngine.IR.Ast.Task.AstPackageBaseNode
    {
        ...
        public override void CloneInto(IFrameworkItem targetItem, Dictionary<IFrameworkItem, IFrameworkItem> cloneMapping)
        {
            ...
            if (targetItem == null || !typeof(AstPackageNode).IsAssignableFrom(targetItem.GetType()))
            {
        ...
        {
            return new AstPackageNode(parentItem);
        }
