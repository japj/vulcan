...
namespace VulcanEngine.IR.Ast.Task
{
    ...
    public partial class AstVariableParameterMappingNode : VulcanEngine.IR.Ast.Task.AstParameterMappingTypeNode
    {
        ...
        public override void CloneInto(IFrameworkItem targetItem, Dictionary<IFrameworkItem, IFrameworkItem> cloneMapping)
        {
            ...
            if (targetItem == null || !typeof(AstVariableParameterMappingNode).IsAssignableFrom(targetItem.GetType()))
            {
                throw new ArgumentException("Provided target node is not of the correct type.");
            }
            var castedTargetItem = (AstVariableParameterMappingNode)targetItem;
            if (_variable == null)
            {
        ...
        {
            return new AstVariableParameterMappingNode(parentItem);
        }
