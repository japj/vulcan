...
namespace VulcanEngine.IR.Ast.Task
{
    ...
    public partial class AstExecuteSqlQueryNode : VulcanEngine.IR.Ast.Task.AstQueryNode
    {
        #region Private Storage
        private VulcanCollection<VulcanEngine.IR.Ast.Task.AstExecuteSqlParameterMappingTypeNode> _parameters;
        ...
        public VulcanCollection<VulcanEngine.IR.Ast.Task.AstExecuteSqlParameterMappingTypeNode> Parameters
        {
        ...
        {
            return new AstExecuteSqlQueryNode(parentItem);
        }
