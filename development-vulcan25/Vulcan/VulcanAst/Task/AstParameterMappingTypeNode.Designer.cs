...
{
    [AstSchemaTypeBindingAttribute("ParameterMappingElemType", "http://tempuri.org/vulcan2.xsd")]
    public abstract partial class AstParameterMappingTypeNode : VulcanEngine.IR.Ast.AstNamedNode
    {
        ...
        public override void CloneInto(IFrameworkItem targetItem, Dictionary<IFrameworkItem, IFrameworkItem> cloneMapping)
        {
            ...
            if (targetItem == null || !typeof(AstParameterMappingTypeNode).IsAssignableFrom(targetItem.GetType()))
            {
