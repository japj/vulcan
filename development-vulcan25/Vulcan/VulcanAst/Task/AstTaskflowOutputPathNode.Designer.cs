...
{
    [AstSchemaTypeBindingAttribute("TaskflowOutputPathElemType", "http://tempuri.org/vulcan2.xsd")]
    public partial class AstTaskflowOutputPathNode : VulcanEngine.IR.Ast.AstNamedNode
    {
        ...
        public override void CloneInto(IFrameworkItem targetItem, Dictionary<IFrameworkItem, IFrameworkItem> cloneMapping)
        {
            ...
            if (targetItem == null || !typeof(AstTaskflowOutputPathNode).IsAssignableFrom(targetItem.GetType()))
            {
        ...
        {
            return new AstTaskflowOutputPathNode(parentItem);
        }
