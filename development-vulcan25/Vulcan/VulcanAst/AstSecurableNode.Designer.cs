...
namespace VulcanEngine.IR.Ast
{
    ...
    [AstSchemaTypeBindingAttribute("SecurableElemType", "http://tempuri.org/vulcan2.xsd")]
    public abstract partial class AstSecurableNode : VulcanEngine.IR.Ast.AstScopeBoundaryNode
    {
        ...
        public override void CloneInto(IFrameworkItem targetItem, Dictionary<IFrameworkItem, IFrameworkItem> cloneMapping)
        {
            ...
            if (targetItem == null || !typeof(AstSecurableNode).IsAssignableFrom(targetItem.GetType()))
            {
                throw new ArgumentException("Provided target node is not of the correct type.");
            }
            var castedTargetItem = (AstSecurableNode)targetItem;
            foreach (var item in _permissions)
            {
