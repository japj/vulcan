...
namespace VulcanEngine.IR.Ast
{
    ...
    public abstract partial class AstScopeBoundaryNode : VulcanEngine.IR.Ast.AstNamedNode, IScopeBoundary
    {
        ...
        public override void CloneInto(IFrameworkItem targetItem, Dictionary<IFrameworkItem, IFrameworkItem> cloneMapping)
        {
            ...
            if (targetItem == null || !typeof(AstScopeBoundaryNode).IsAssignableFrom(targetItem.GetType()))
            {
